# Generated by Django 3.0.5 on 2020-06-17 12:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(max_length=15, unique=True, validators=[django.core.validators.RegexValidator(message="Номер телефона должен быть в формате: '+999999999'.Разрешено до 14 цифр.", regex='^\\+?1?\\d{9,14}$')], verbose_name='Номер телефона')),
